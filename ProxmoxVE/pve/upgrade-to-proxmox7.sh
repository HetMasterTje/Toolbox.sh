...
# Remove invalid bullseye/updates entries if they exist
...
# Update and upgrade
apt update
DEBIAN_FRONTEND=noninteractive apt install -y proxmox-upgrade

# Run upgrade
proxmox-upgrade

echo "✅ Proxmox VE 7 upgrade complete. Please reboot your system."
